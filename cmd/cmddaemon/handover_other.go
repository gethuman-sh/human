...
func maybeWatchBinary(_ context.Context, _ *listenerSet, _ *daemon.Server, _ handoverHooks, _ context.CancelFunc, _ *atomic.Bool, _ daemon.DaemonInfo, logger zerolog.Logger) {
