...
```
Task(subagent_type="human-reviewer", model="opus", prompt="Review changes for ticket <DISPATCHED_KEY> --branch=<branch> --commits=<commits>", run_in_background=false)
```
