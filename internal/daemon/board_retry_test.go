...
func TestTryRelaunch_RetryableStageIsRelaunchedAndNoted(t *testing.T) {
	...
	ok := policy.tryRelaunch(context.Background(), "SC-1", BoardImplementation, nil, rec, "daemon-1", zerolog.Nop())
...
func TestTryRelaunch_RefusedRelaunchSpendsNoAttempt(t *testing.T) {
	...
	ok := policy.tryRelaunch(context.Background(), "SC-1", BoardImplementation, nil, rec, "d", zerolog.Nop())
...
func TestTryRelaunch_NoteIsNotAStageMarker(t *testing.T) {
	...
	policy.tryRelaunch(context.Background(), "SC-1", BoardPlanning, nil, rec, "daemon-1", zerolog.Nop())
...
func TestTryRelaunch_OutageDoesNotChargeBudget(t *testing.T) {
	...
	require.True(t, policy.tryRelaunch(ctx, "SC-1", BoardImplementation, nil, rec, "daemon-1", zerolog.Nop()))
	require.True(t, policy.tryRelaunch(ctx, "SC-1", BoardImplementation, nil, rec, "daemon-1", zerolog.Nop()))
	require.True(t, policy.tryRelaunch(ctx, "SC-1", BoardImplementation, nil, rec, "daemon-1", zerolog.Nop()))
...
func TestTryRelaunch_OutageWithoutCommenterStillRelaunches(t *testing.T) {
	...
	ok := policy.tryRelaunch(context.Background(), "SC-1", BoardVerification, nil, nil, "d", zerolog.Nop())
...
func TestTryRelaunch_DoneWithoutTheDoneMarkerStopsAtTheAttemptCap(t *testing.T) {
	...
	require.True(t, policy.tryRelaunch(ctx, "SC-1", BoardPlanning, nil, rec, "d", zerolog.Nop()))
	require.True(t, policy.tryRelaunch(ctx, "SC-1", BoardPlanning, nil, rec, "d", zerolog.Nop()))
	require.False(t, policy.tryRelaunch(ctx, "SC-1", BoardPlanning, nil, rec, "d", zerolog.Nop()),
