...
export const DAEMON_FORWARDED_STATES = ["running", "queued", "done", "failed", "resolved", "outage"] as const;
...
export const FLOW_STATES = ["flowing", "idle", "stalled", "unknown"] as const;
