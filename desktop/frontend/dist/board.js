...
const QUEUE_NOTES = {
    ...
    product: "Drop an idea: guided ideation (evolve) rewrites the same ticket — product language, idea label removed",
    engineering: "Drop: <code>human-plan</code> drafts the engineering plan onto the ticket as a <code>[human:plan]</code> comment",
    building: "Drop: <code>human-execute</code> works the plan on a branch — commits, self-check, then <code>human-review</code> chains automatically",
...
function appendQueueNote(col, queue) {
