...
export function notMineOpacity(dimPercent) {
    if (typeof dimPercent !== "number" || !Number.isInteger(dimPercent))
        return null;
    if (dimPercent < MIN_DIM_PERCENT || dimPercent > MAX_DIM_PERCENT)
        return null;
...
export function applyNotMineOpacity(root, dimPercent) {
